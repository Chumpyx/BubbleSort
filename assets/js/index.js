...
var boxesInfos = {
	...
	"colors": ["FA84C9", "EF1717", "3998F6", "404040", "FB952C", "AA5EF6", "56CF3E"] // Add colors if more then 8 tubes !!!
};
var tubeInfos = {
	"size": {
...
function addBox(iRowTube, iColumnTube, boxColor) {
	...
	let box = draw.rect(boxesInfos.size.width, boxesInfos.size.height).attr({fill: "#" + boxColor}).move(boxPosition.x, boxPosition.y);
